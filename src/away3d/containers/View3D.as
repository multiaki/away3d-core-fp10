package away3d.containers
{
	...
	import away3d.core.project.PrimitiveProjector;
	...
	import away3d.core.utils.HitManager;
	 ...
	 */
	public class View3D extends SpriteUtil
	{
		/** @private */
		...
		private function createStatsMenu(event:Event = null):void
		{
			...
			addListener(stage, Event.RESIZE, onStageResized, false, 0, true);
		}
	  	...
	  	public function set stats(b:Boolean):void
        {
            ...
            if(b && stage) 
                ...
                addListener(this, Event.ADDED_TO_STAGE, createStatsMenu);    
        }
		...
		public function View3D(init:Object = null)
		{
            ...
            addListener(this, MouseEvent.MOUSE_UP, onMouseUp);
            addListener(this, MouseEvent.ROLL_OUT, onRollOut);
            addListener(this, MouseEvent.ROLL_OVER, onRollOver);
        ...
        {
            addListener(this, MouseEvent3D.MOUSE_MOVE, listener, false, 0, false);
        }
        ...
        {
            addListener(this, MouseEvent3D.MOUSE_DOWN, listener, false, 0, false);
        }
        ...
        {
            addListener(this, MouseEvent3D.MOUSE_UP, listener, false, 0, false);
        }
        ...
        {
            addListener(this, MouseEvent3D.MOUSE_OVER, listener, false, 0, false);
        }
        ...
        {
            addListener(this, MouseEvent3D.MOUSE_OUT, listener, false, 0, false);
        }
        ...
        {
            addListener(this, ViewEvent.VIEW_UPDATED, listener, false, 0, false);
        }
